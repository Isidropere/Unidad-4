...
namespace Iperez_MVC_ActionLink_DiplomadoUASD.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Cliente,Nombre,Apellido,Cedula,Telefono")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Cliente,Nombre,Apellido,Cedula,Telefono")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
